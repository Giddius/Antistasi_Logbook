...
from gidapptools.general_helper.conversion import seconds2human, FILE_SIZE_REFERENCE, human2bytes, bytes2human, TimeUnits, TimeUnit, human2timedelta
...
from PySide6.QtWidgets import (QApplication, QGridLayout, QMainWindow, QMenu, QMenuBar, QSizePolicy, QStatusBar, QButtonGroup, QWidget, QPushButton, QFrame, QFormLayout, QLabel, QProgressBar, QProgressDialog,
                               QBoxLayout, QHBoxLayout, QDialogButtonBox, QStackedWidget, QCheckBox, QLineEdit, QRadioButton, QSpacerItem, QStackedLayout, QTimeEdit, QDateTimeEdit, QSpinBox, QDoubleSpinBox, QVBoxLayout, QTextEdit, QComboBox, QFontComboBox, QColorDialog, QSizePolicy, QMessageBox, QLayout, QGroupBox, QDockWidget, QTabWidget, QSystemTrayIcon, QTableView, QListView, QTreeView, QColumnView)
from antistasi_logbook.gui.resources.style_sheets import ALL_STYLE_SHEETS
from antistasi_logbook.gui.resources.antistasi_logbook_resources_accessor import AllResourceItems
from antistasi_logbook.gui.widgets.form_widgets.type_widgets import ALL_VALUE_FIELDS, StringChoicesValueField, BoolValueField, IntegerValueField, FloatValueField, StringValueField, ListValueField, PathValueField, TimeDeltaValueField, FileSizeValueField
