...
.. highlights::
   ...
   It is currently :underline:`**NOT**` advised to install via `pip install`, because of problems with dependencies (*Peewee* especially) this will :underline:`**NOT**` result in a working app.
